...
3. Flag criteria with temporal conditions (e.g. "within 4 weeks"), numeric thresholds
   (e.g. "eGFR >= 30"), or conditional logic (e.g. "unless HbA1c < 7").
4. Flag criteria with ambiguous language (e.g. "clinically significant", "adequate").
5. Do NOT invent, infer, or paraphrase criteria. Only extract what is explicitly stated.
6. Output ONLY valid JSON matching the schema provided. No prose.
"""
